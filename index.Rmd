...
Overall, the accuracy of 85.3% is quite ok, however, there may be other way better.
...
The overall accuracy of approximately 95% is pretty impressive for a Random Forest. If we take a closer look at the class error, it looks a lot like the Simple Least Squares classifier. It seems that 1 and 0 are the easiest to classify, but 5 and 8 are a bit more tricky.

### 3.3. Softmax with nnet
